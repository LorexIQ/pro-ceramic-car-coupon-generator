...
<template>
  <div class="line-editor">
    ...
    <label class="line-editor__label"
      >Прозрачность: {{ Math.round(props.line.opacity * 100) }}%</label
    >
    ...
    <label class="line-editor__label"
      >Отступ сверху: {{ Math.round(props.line.spacingBefore) }}px</label
    >
    ...
    <div class="line-editor__row">
      ...
      <label class="line-editor__label line-editor__underline"
        >Подчёркивание <n-switch v-model:value="props.line.underline" size="small"
      /></label>
    </div>
  </div>
</template>
